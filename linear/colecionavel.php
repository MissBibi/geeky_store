	...
	<!-- Featured -->
        ...
        <tbody>
          ...
          <?php } while ($row_colecionavel = mysql_fetch_assoc($colecionavel)); ?>         
            ...
            <table border="0">
              <tr>
                <td><?php if ($pageNum_colecionavel > 0) { // SAparece quaso não seja a primeira pagina ?>
                ...
                <td><?php if ($pageNum_colecionavel > 0) { // Aparece quaso não seja a primeira pagina ?>
                    ...
                    <?php } // Aparece quaso não seja a primeira pagina ?></td
                <td><?php if ($pageNum_colecionavel < $totalPages_colecionavel) { // Aparece quaso não seja a ultima pagina ?>
