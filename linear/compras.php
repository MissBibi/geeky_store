...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO compra (datacompra, ncartao, cv, total, cliente_email) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['datacompra'], "date"),
                       GetSQLValueString($_POST['ncartao'], "int"),
                       GetSQLValueString($_POST['cv'], "int"),
  ...
  $insertGoTo = "comprasuc.php?codigo=" . $row_produto['codproduto'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
			...
			<form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form2">
			  <table class="darkTable2">
			    <tr>
			      ...
			      <td width="155"><?php echo $row_cliente['nome']; ?></td>
			      <td width="350" rowspan="14"><input name="imageField" type="image" id="imageField" src="../imagens/<?php echo $row_produto['imagem']; ?>" align="top" width="250" height="250"></td>
		        </tr>
			    <tr>
			    ...
			    <tr>
			      <td>Morada do cliente:</td>
			      <td><?php echo $row_cliente['morada']; ?></td>
		        </tr>
			    <tr>
			      <td>Codigo postal do cliente:</td>
			      <td><?php echo $row_cliente['codpostal']; ?>-<?php echo $row_cliente['cospostal2']; ?></td>
		        </tr>
			    <tr>
			      <td>Localidade do cliente:</td>
			      <td><?php echo $row_cliente['localidade']; ?></td>
		        </tr>
			    <tr>
			      <td>Nif do cliente:</td>
			      <td><?php echo $row_cliente['nif']; ?></td>
		        </tr>
			    <tr>
			      <td>&nbsp;</td>
			      <td>&nbsp;</td>
			    ...
			    <tr>
			      ...
			      <td><?php echo $row_produto['nomep']; ?></td>
		        </tr>
			    <tr>
			      <td>Preço do produto:</td>
			      <td><?php echo $row_produto['precou']; ?></td>
		        </tr>
			    <tr>
			      <td>status</td>
			    ...
			    <tr>
			      <td>numero de cartão</td>
			      <td><input type="text" name="ncartao" id="ncartao"></td>
		        </tr>
			    <tr>
			      <td height="26">
			        
			        <input name="email" type="hidden" id="email" value="<?php echo $row_cliente['email']; ?>">
			        <input name="total" type="hidden" id="total" value="<?php echo $row_produto['precou']*"quantidade"; ?>">
			        <input name="datacompra" type="hidden" id="datacompra" value="<?php echo date('Y-m-d H:i');?>">
		          cv</td>
			      <td><input type="text" name="cv" id="cv" maxlength="3"></td>
		        </tr>
			    <tr>
                <?php 
					if($row_produto['stock']<=0):?>
                <td width="150"> <?php echo $row_produto['status']='Indisponivel';?></td>
                 <?php 
					elseif($row_produto['stock']>0):?>
                <td width="150"> <?php echo $row_produto['status']='Disponivel';?></td>
                <?php endif ?>
			      <td colspan="3"><input type="submit" name="comprar" id="comprar" value="comprar"></td>
		        </tr>
		      </table>
		  <p>&nbsp;</p>
