...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO marca (marca) VALUES (%s)",
...
<html>
	...
	<form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
		<table class="darkTable2">
        		<thead>
          		<tr>
	      			<th colspan="2"><div align="center">Inserir Marca Do Produto</div></th>
          		</tr>
       			</thead>
        		<tbody>
        		<tr>
	      			<td width="213">Nome Marca</td>
	      			<td width="194"><span id="sprytextfield2">
