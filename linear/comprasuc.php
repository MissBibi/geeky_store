...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE produto SET stock=%s WHERE codproduto=%s",
		  ...
		  <form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
		    <p>&nbsp;</p>
		      ...
		      <table width="283" border="1">
		        <tr>
		          <td width="269">COMPRA EFETUADA COM SUCESSO</td>
	            </tr>
		        <tr>
		          <td><input name="stock" type="hidden" id="stock" value="<?php echo $row_produto['stock']-1 ?>">
		            
	              <input name="codigo" type="hidden" id="codigo" value="<?php echo $row_produto['codproduto']; ?>">		            <input type="submit" name="prod" id="prod" value="Inicio"></td>
	            </tr>
	        </table>
		      <p>&nbsp;</p>
	      <p>&nbsp;</p>
